...
export default function AraclarPage() {
  ...
  const TOOLS = [
    ...
    { href: "/projeler", title: isEn ? "Project Website" : "Proje Web Sitesi", desc: isEn ? "Generate a customisable landing page for your project. 4 templates, 3 header versions (TR+EN), footer logo library." : "Projeniz için özelleştirilebilir landing page oluşturun. 4 şablon, 3 header versiyonu (TR+EN), footer logo kütüphanesi.", color: "#1E3A8A", icon: "🌐", imageUrl: "/tools/proje-websitesi.png" },
  ];
